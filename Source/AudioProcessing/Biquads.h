...
//
//        if (firstOrder) {
//            float theta = 2.0f*PI*fc / SAMPLE_RATE;
//            float y = std::cos(theta) / (1.0f + std::sin(theta));
//
//            a0 = (1.0f - y) / 2.0f;
//            a1 = (1.0f - y) / 2.0f;
//            a2 = 0.0f;
...
//            float theta = 2.0f*PI*fc / SAMPLE_RATE;
//            float d = 1.0f / Q;
//            float beta = 0.5f * (1.0f - 0.5f*d*std::sin(theta)) / (1.0f + 0.5f*d*std::sin(theta));
//            float y = (0.5f + beta) * std::cos(theta);
//
//            a0 = (0.5f + beta - y) / 2.0f;
//            a1 = (0.5f + beta - y);
//            a2 = (0.5f + beta - y) / 2.0f;
